  ...
  <div class="inwrap">
    <div id="header-top">
        ...
        <?php if (theme_get_setting('social_links', 'corporate')): ?>
          ...
          <div class="search-block"><?php print render($page['front_welcome']); ?></div>
           <ul>
...
<div class="bottom" style="height:200px; margin:0px;">
   ...
   <?php if (theme_get_setting('footer_copyright', 'corporate') || theme_get_setting('footer_credits', 'corporate')): ?>
    <div id="footer">
      <?php if (theme_get_setting('footer_copyright', 'corporate')): ?>
        <div class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?>.
         <p style="font:bold 9pt arial;">Site designed and mantained by Akal Purakh Technologies</p>
        </div>
      <?php endif; ?>
